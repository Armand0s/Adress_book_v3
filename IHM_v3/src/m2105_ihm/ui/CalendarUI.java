...
public class CalendarUI extends JTextField {
    ...
    public CalendarUI(String dateFormatPattern, Date date) {
        this(date);
        DEFAULT_DATE_FORMAT = dateFormatPattern;
    }

    public CalendarUI(Date date) {
        setDate(date);
        setEditable(false);
    ...
    private void showDateDialog(DatePanel dateChooser, Point position) {
        Frame owner = (Frame) SwingUtilities
                .getWindowAncestor(CalendarUI.this);
